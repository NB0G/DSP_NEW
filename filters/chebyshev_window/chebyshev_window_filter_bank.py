...
class ChebyshevWindowFirFilterBank:
    def __init__(
        ...
        window_attenuation_db=DEFAULT_WINDOW_ATTENUATION_DB,
    ):
    ...
    def rebuild_kernel(self):
        ...
        window = chebwin(len(kernel), at=self.window_attenuation_db).tolist()
    ...
    def band_gain_for_frequency(self, frequency_hz):
        ...
        for band_index, (low_cutoff_hz, high_cutoff_hz) in enumerate(
            ...
            is_last_band = band_index == len(CHEBYSHEV_WINDOW_BANDS)
